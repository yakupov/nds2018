...
abstract class AbstractCJFBYCorrectnessTest extends ManagedPopulationCorrectnessTest {
    @Override
    protected abstract CJFBYPopulation constructPopulation(int dimensionsCount);

    @SuppressWarnings("ConstantConditions")
    @Test
    public void testWithRemoval() {
        final CJFBYPopulation pop = constructPopulation(3);
        ...
        List<IIndividual> level1 = pop.getSnapshot().getLevels().get(1).getMembers();
